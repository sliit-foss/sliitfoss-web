...
function BentoCard({
  ...
  const inner = (
    <div
      className={`h-full rounded-2xl border border-white/[0.06] bg-white/[0.02] transition-all duration-300 hover:border-white/12 group relative overflow-hidden ${className}`}
    >
      {children}
    </div>
  );
        ...
        <Stagger className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4 auto-rows-[140px] md:auto-rows-[180px]">
            ...
            >
              ...
              <div className="relative">
                ...
                <p className="text-sm text-white/30 leading-relaxed max-w-xs">
                  24-hour open source hackathon. Build real projects. Ship real
                  code.
                </p>
              </div>
          ...
          {stats.map((stat) => (
            <StaggerItem key={stat.label}>
              <BentoCard tilt={false} className="p-6 flex flex-col justify-center items-center text-center hover:border-white/10">
                <div className="font-heading text-3xl md:text-4xl font-bold text-gradient mb-1">
                  {stat.value}
                </div>
                <div className="text-[0.7rem] text-white/30 uppercase tracking-widest">
                  {stat.label}
                </div>
              </BentoCard>
            </StaggerItem>
          ...
          <StaggerItem>
            <BentoCard tilt={false} className="p-5 flex flex-col justify-center">
              <div className="font-mono text-[0.65rem] text-emerald-400/60 mb-2">
                $ whoami
              </div>
              <div className="text-xs text-white/40 leading-relaxed">
                FOSS advocates at SLIIT. We build, learn, and contribute to open
                source.
              </div>
            </BentoCard>
          </StaggerItem>
          ...
          <StaggerItem>
            ...
            >
              ...
              <div className="relative">
                <span className="font-mono text-[0.6rem] text-violet-400/60 uppercase tracking-wider">
                  Blog
                </span>
                <h4 className="text-sm font-semibold mt-2 leading-snug">
                  Why We Rewrote Our CLI in Rust
                </h4>
              </div>
          ...
          <StaggerItem>
            ...
            >
              <div>
                <div className="font-mono text-[0.6rem] text-cyan-400/60 uppercase tracking-wider">
                  Workshop
                </div>
                <h4 className="text-sm font-semibold mt-2 leading-snug">
                  Git & GitHub
          ...
          <StaggerItem className="col-span-2">
            ...
            >
              ...
              <div className="flex-1 relative">
                <span className="font-mono text-[0.6rem] text-teal-400/60 uppercase tracking-wider">
                  Blog
                </span>
                <h4 className="text-base font-semibold mt-1.5 leading-snug">
                  Your First Open Source Contribution
                </h4>
                <p className="text-xs text-white/25 mt-1.5">
                  A step-by-step guide from fork to merged PR.
                </p>
              </div>
          ...
          <StaggerItem>
            <BentoCard
              href="/events/rust-beginners"
              className="p-5 flex flex-col justify-between hover:border-orange-500/20"
            >
              <div>
                <div className="font-mono text-[0.6rem] text-orange-400/60 uppercase tracking-wider">
                  Tech Talk
                </div>
                <h4 className="text-sm font-semibold mt-2 leading-snug">
                  Rust for
          ...
          <StaggerItem>
            ...
            >
              ...
              <div className="relative">
                <span className="font-mono text-[0.6rem] text-blue-400/60 uppercase tracking-wider">
                  Blog
                </span>
                <h4 className="text-sm font-semibold mt-2 leading-snug">
                  Docker in 10 Min for Students
                </h4>
              </div>
