        ...
        <div className="max-w-5xl mx-auto">
          <div className="flex items-center gap-3 mb-4">
            ...
            {event.status === "completed" && (
              <span className="text-xs px-2 py-0.5 rounded-full bg-black/[0.06] text-[#999]">
                Completed
              </span>
            )}
          </div>
            ...
            <FadeUp delay={0.1}>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-12">
                {event.speakers.map((speaker) => (
                  <div
                    key={speaker.name}
                    className="p-4 rounded-xl border border-black/[0.04] bg-[#fafafa]"
                  >
            ...
            <FadeUp delay={0.2}>
              ...
              <div className="space-y-0 mb-12">
                {event.schedule.map((item, i) => (
                  <div
                    key={i}
                    className="flex gap-4 py-3 border-b border-black/[0.04] last:border-0"
                  >
                    <span className="font-mono text-sm text-[#999] shrink-0 w-14">
                      {item.time}
                    </span>
